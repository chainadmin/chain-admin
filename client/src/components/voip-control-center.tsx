...
function Routing({ buckets, users, numbers, accent, dark, assign, remove, editing, setEditing, creating, setCreating, toggleCallerIdBucket }: { buckets: Bucket[]; users: TeamMember[]; numbers: VoiceNumber[]; accent: string; dark: boolean; assign: (x: {id:string;bucketId:string|null}) => void; remove:(id:string)=>void; editing:Bucket|null; setEditing:(x:Bucket|null)=>void; creating:boolean; setCreating:(x:boolean)=>void; toggleCallerIdBucket: (x: { id: string; enabled: boolean }) => void }) {
