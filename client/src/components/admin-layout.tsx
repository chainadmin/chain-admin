...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const standardNavigationItems = [
    ...
    { name: "Auto Dialer", href: buildNavHref("/auto-dialer"), icon: "fas fa-bullhorn" },
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#111f3b] to-[#152a54] text-blue-50">
      ...
      <div className="relative flex min-h-screen overflow-hidden">
        ...
        <div className="flex flex-1 flex-col overflow-hidden bg-[#0f172a]">
          <div className="relative z-50 flex h-20 flex-shrink-0 items-center border-b border-white/10 bg-[#0f172a] px-4">
            <button
              type="button"
