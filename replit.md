...
- **Arrangement Management**: Features a balance tier dropdown system (replacing min/max inputs) with predefined tiers (under_3000, tier_3000_5000, tier_5000_10000, tier_10000_25000, tier_25000_50000, over_50000). Includes a comprehensive calculation engine that filters arrangement options by consumer balance, calculates specific payment amounts for each plan type, enforces tenant minimum monthly payment settings, and validates all plan constraints (max payment, max term). Consumer portal displays calculated arrangements with specific amounts instead of ranges and distinguishes between template options and existing SMAX arrangements.
