...
| Voice | IMPLEMENTED — LIVE TEST REQUIRED | Chiamo reuses shared Voice infrastructure behind one bundled phone-system entitlement. Calling, routing, voicemail, recording and IVR activate and suspend together; inactive billing blocks authenticated Voice APIs and inbound/outbound provider TwiML. |
