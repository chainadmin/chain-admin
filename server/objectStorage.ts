...
export class ObjectStorageService {
  ...
  // Upload logo directly to object storage
  async uploadLogo(file: Buffer, tenantId: string, mimeType: string): Promise<{ url: string; path: string } | null> {
    try {
      ...
      // Use first public search path for logos
