...
export const defaultBlocks = {
  ...
  accountDetails: (): AccountDetailsBlock => ({
    ...
    fields: [
      ...
      { label: 'File Number', variable: '{{filenumber}}', show: false },
      ...
      { label: 'Address', variable: '{{address}}', show: false },
      { label: 'City', variable: '{{city}}', show: false },
      { label: 'State', variable: '{{state}}', show: false },
      { label: 'Zip Code', variable: '{{zipCode}}', show: false },
    ],
    borderColor: '#e5e7eb',
